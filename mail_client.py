...
def get_inbox(recipient: str) -> None:
    ...
    Gets the inbox of the given recipient by making a GET request to the /mail/inbox/{recipient} endpoint.
...
def get_sent(sender: str) -> None:
    ...
    Gets the sent mail of the given sender by making a GET request to the /mail/sent/{sender} endpoint.
...
def get_mail(mail_id: str) -> None:
    ...
    Gets a mail with the given id by making a GET request to the /mail/{mail_id} endpoint.
    
    Args:
        mail_id (str): The id of the mail to be retrieved
...
def delete_mail(mail_id: str) -> None:
    ...
    Deletes a mail with the given id by making a DELETE request to the /mail/{mail_id} endpoint.
